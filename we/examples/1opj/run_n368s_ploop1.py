...
if __name__ == '__main__':
    ...
    # file paths
    ref_file = "../../example_inputs/1OPJ/N368S/md.gro"

    initial_positions = []
    for i in range(135):
        u = mda.Universe(f"../../example_inputs/1OPJ/N368S/1OPJ_N368S_ploop_path/frame_{i}.gro")
    ...
    points = np.load("../../example_inputs/1OPJ/N368S/1OPJ_N368S_ploop_path/ploop_path.npy")
    ...
    config = {
        ...
        'n_iterations': 50000,
        'flux_file': 'n368s_flux_ploop_algebric_clean10.txt',
        'bin_file': 'n368s_bin_ploop_algebric_clean10.txt',
        'walkers_file': 'n368s_walker_ploop_algebric_clean10.txt',
        'survive_empty': False,
        'warp_function': warp_criteria,
        'warp_kwargs': warp_kwargs,
        'h5_atom_indices' : list(range(0, 4760)),
        'traj_file' : 'full_space_n368s_ploop2_algebric_clean.h5'
    }
