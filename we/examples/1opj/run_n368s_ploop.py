...
if __name__ == '__main__':
    ...
    config = {
        ...
        'n_iterations': 50000,
        'flux_file': 'n368s_flux_ploop_algebric_clean6.txt',
        'bin_file': 'n368s_bin_ploop_algebric_clean6.txt',
        'walkers_file': 'n368s_walker_ploop_algebric_clean6.txt',
        'survive_empty': False,
        'warp_function': warp_criteria,
        'warp_kwargs': warp_kwargs,
        'h5_atom_indices' : list(range(0, 4760)),
        'traj_file' : 'full_space_n368s_ploop6_algebric_clean.h5'
    }
