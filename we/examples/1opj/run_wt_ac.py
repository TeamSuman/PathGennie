...
if __name__ == '__main__':
    ...
    # file paths
    ref_file = "../../example_inputs/1OPJ/WT/md.gro"

    initial_positions = []
    for i in range(135):
        u = mda.Universe(f"../../example_inputs/1OPJ/WT/1OPJ_WT_ac_path/frame_{i}.gro")
    ...
    points = np.load("../../example_inputs/1OPJ/WT/1OPJ_WT_ac_path/ac_path.npy")
    ...
    config = {
        ...
        'bin_file': 'wt_bin_ac_algebric_clean1.txt',
        'walkers_file': 'wt_walker_ac_algebric_clean1.txt',
        'survive_empty': False,
        'warp_function': warp_criteria,
        'warp_kwargs': warp_kwargs,
        'h5_atom_indices' : list(range(0, 4682)),
        'traj_file' : 'full_space_wt_ac1_algebric_clean.h5'
    }
