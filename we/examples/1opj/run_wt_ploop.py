...
if __name__ == '__main__':
    ...
    # file paths
    gro_file = "../../example_inputs/1OPJ/WT/md.gro"

    initial_positions = []
    for i in range(135):
        u = mda.Universe(f"../../example_inputs/1OPJ/WT/1OPJ_WT_ploop_path/frame_{i}.gro")
    ...
    points = np.load("../../example_inputs/1OPJ/WT/1OPJ_WT_ploop_path/ploop_path.npy")
    ...
    # Updated Config for OpenMMRunner flexibility
    config = {
        'n_gpus': 2,
        'runner_class': OpenMMRunner,
        'runner_kwargs': {
            'gro_file': "../../example_inputs/1OPJ/WT/md.gro",
            'top_file': "../../example_inputs/1OPJ/WT/topol.top",
            'dt_ps': 0.002,
            'temperature': 300.0,
            'platform': 'CUDA'
        },
        ...
        'walkers_file': 'wt_walker_ploop_algebric_clean1.txt',
        'survive_empty': False,
        'warp_function': warp_criteria,
        'warp_kwargs': warp_kwargs,
        'h5_atom_indices' : list(range(0, 4682)),
        'traj_file' : 'full_space_wt_ploop1_algebric_clean.h5'
    }
