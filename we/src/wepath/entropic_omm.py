...
class OpenMMRunner:
    def __init__(self, device=0):
        ...
        self.temperature = 200 * unit.kelvin
        ...
        # --- 3. Integrator ---
        self.integrator = mm.LangevinIntegrator(self.temperature, self.friction, self.timestep)
    ...
    def _create_simulation(self):
        ...
        self.simulation = app.Simulation(self.topology, self.system, new_integrator, self.platform, self.properties)
